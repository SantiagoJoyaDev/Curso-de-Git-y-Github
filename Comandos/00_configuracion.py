...
# Para la crecion de carpetas --> mkdir "Nombre de la carpeta" 
# Para la crecion de archivos --> touch "Nombre del archivo"
# Para crear un archivo gitignore --> touch .gitignore
